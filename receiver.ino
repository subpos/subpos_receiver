...
//typedef struct sps_data sps_data;
        ...
        if (incomingByte == '\r') {
          ...
          if (incomingByte == '\n') 
          {
            ...
            while (num_scan != 0) {
              ...
              //Serial.println(rssi - 65536, DEC);


              //Do SubPos decode thing
              ...
              //Serial.println(decoded_data.dev_id, DEC); 
              //Serial.println(decoded_data.lat, DEC); 
              //Serial.println(decoded_data.lng, DEC); 
              //Serial.println(merc_y((double)decoded_data.lat/10000000), DEC); 
              //Serial.println(merc_x((double)decoded_data.lng/10000000), DEC); 
              //Serial.println(decoded_data.altitude, DEC); 
              //Serial.println(decoded_data.tx_pwr, DEC); 
              num_scan--;
              ...
              //Serial.println(beacons.size(), DEC);  
            ...
            if (beacons.size() == 1) 
            {
                //Serial.println(decoded_data.lat, DEC);
                //Serial.println(decoded_data.lng, DEC);
                //location[0] = decoded_data.lat;
                //location[1] = decoded_data.lng;
            ...
            else if (beacons.size() == 2) 
            {
              ...
              beacons.push_back(PosAndDistance2d(Pos2d(beacons[1].m_pos(0), beacons[0].m_pos(1)), beacons[1].m_distance));
                ...
                /*double dist_between = sqrt(pow((beacons[0].m_pos(0) - beacons[1].m_pos(0)),2) + pow((beacons[0].m_pos(1) - beacons[1].m_pos(1)),2));
                double dist_ratio = 0;
                if ( beacons[0].m_distance > beacons[1].m_distance) {
                  dist_ratio = beacons[1].m_distance/beacons[0].m_distance * dist_between;
                } else {
                  dist_ratio = dist_between - (beacons[0].m_distance/beacons[1].m_distance * dist_between);

                }
                Serial.println(dist_between, DEC);
                Serial.println(dist_ratio, DEC);*/
                /*Serial.println(merc_lon(beacons[0].m_pos(1)), DEC);
                Serial.println(merc_lat(beacons[0].m_pos(0)), DEC);
                Serial.println(merc_lon(beacons[1].m_pos(1)), DEC);
                Serial.println(merc_lat(beacons[1].m_pos(0)), DEC);*/
                
              /*  double vx = beacons[1].m_pos(0) - beacons[0].m_pos(0);
                double vy = beacons[1].m_pos(1) - beacons[0].m_pos(1);
                ...
                double px = ((double)beacons[0].m_pos(0) + vx * (mag + distance));
                double py = ((double)beacons[0].m_pos(1) + vy * (mag + distance));
                Serial.println(merc_lat(px), DEC);
                Serial.println(merc_lon(py), DEC);*/
